    ...
    def _generate_structured_response_once(
        ...
        *,
        ...
        instruction = (
            ...
            "Identifica explícitamente los campos mencionados por el usuario y valida que las claves que generes coincidan "
            "con los nombres definidos en el esquema (respetando acentos y mayúsculas). "
            "Cuando alguna clave no pueda mapearse, documenta el supuesto en 'Descripción' y evita agregar estructuras "
            "improvisadas. "
            ...
            "Si detectas que la respuesta se está volviendo excesivamente extensa o incluye catálogos amplios, detente y "
            "limita la regla a los 2 a 3 escenarios más representativos, explicando en 'Descripción' cómo ampliarla si es necesario. "
            "Mantén el JSON conciso: no repitas bloques equivalentes y evita información irrelevante. "
